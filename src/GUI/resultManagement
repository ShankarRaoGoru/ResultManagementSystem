...
public class Home extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 330, 128, -1));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/GUI/schoolPic1.jpg"))); // NOI18N
        jLabel2.setText("jLabel2");
        jLabel2.setMaximumSize(new java.awt.Dimension(700, 450));
        jLabel2.setMinimumSize(new java.awt.Dimension(700, 450));
        jLabel2.setPreferredSize(new java.awt.Dimension(700, 450));
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(-308, -180, 1010, 630));
